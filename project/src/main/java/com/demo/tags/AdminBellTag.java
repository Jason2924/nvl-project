...
public class AdminBellTag extends RequestContextAwareTag {
	...
	public void doFinally() {
		try {
			String viewPath = "../tags/admin_bell/index.jsp";
			HttpServletRequest request = (HttpServletRequest) pageContext.getRequest();
			request.setAttribute("paypalList", orderService.retrieveOrderPaypalPayment());
			/*

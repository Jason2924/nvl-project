...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/userplugins/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/userplugins/styles/shop_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/userplugins/styles/shop_responsive.css">

<!-- Home -->

<div class="home">
	<div class="home_background parallax-window" data-parallax="scroll"
		data-image-src="${pageContext.request.contextPath }/resources/upload/images/products/shop_background.jpg"></div>
					...
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							<c:forEach var="category" items="${categoryList }">
								<li><a href="${pageContext.request.contextPath }/shop/category?id=${category.id }">${category.name }</a></li>
							</c:forEach>
						</ul>
					</div>
					<div class="sidebar_section">
						...
						<ul class="brands_list">
							<c:forEach var="brand" items="${brandList }">
								<li class="brand"><a href="${pageContext.request.contextPath }/shop/brand?id=${brand.id }">${brand.name }</a></li>
							</c:forEach>
						</ul>
					</div>
				</div>
				...
				<div class="shop_content">
					<div class="shop_bar clearfix">
						...
						<div class="shop_sorting">
							...
							<ul>
								<li>
								<span class="sorting_text">Original Order<i class="fas fa-chevron-down"></span></i>
									<ul>
					...
					<div class="product_grid">
						...
						<jsp:useBean id="listHolder" scope="request"
							type="org.springframework.beans.support.PagedListHolder" />
						
						<c:forEach var="product" items="${listHolder.pageList }">
							...
							<div class="product_item is_new">
								...
								<div class="product_content">
									...
									<c:choose>
										...
										<c:when test="${discount > 0 && productPrice > 0 }">
											<div class="product_price viewed_price">
									...
									<div class="product_name">
										<div>
											<a href="${pageContext.request.contextPath }/product?id=${product.id }" tabindex="0">${product.name }</a>
										</div>
									</div>
								</div>
								...
								<ul class="product_marks">
									...
									<li class="product_mark product_discount" style="display: inline-block; visibility: visible; opacity: 1;">
					...
					<c:url value="/${currentLink }" var="pagedLink">
						<c:param name="page" value="~" />
					</c:url>
					<tg:pagination pagedListHolder="${listHolder}" pagedLink="${pagedLink}" />
					</div>
